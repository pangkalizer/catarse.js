                             ...
                             m('.w-row', [
                                 m('.w-col.w-col-4', [
                                     m('div', [
                                         ...
                                         m.trust('&nbsp;'),
                                         m('span.fontsize-base.text-error', `Php ${h.formatNumber(Math.abs(item.debit), 2, 3)}`)
                                     ])
                                 ]),
                                 m('.w-col.w-col-4', [
                                     m('div', [
                                         ...
                                         m.trust('&nbsp;'),
                                         m('span.fontsize-base.text-success', `Php ${h.formatNumber(item.credit, 2, 3)}`)
                                     ])
                                 ]),
                                 m('.w-col.w-col-4', [
                                     m('div', [
                                         ...
                                         m.trust('&nbsp;'),
                                         m('span.fontsize-base', `Php ${h.formatNumber(item.total_amount, 2, 3)}`)
                                     ])
                                 ])
                             ])
                         ])
                 ...
                 (ctrl.expanded() ? m('.card', _.map(item.source, (transaction) => {
                     ...
                     return m('div', [
                         m('.w-row.fontsize-small.u-marginbottom-10', [
                             m('.w-col.w-col-2', [
                                 m(`.text-${(pos ? 'success' : 'error')}`, `${pos ? '+' : '-'} Php ${h.formatNumber(Math.abs(transaction.amount), 2, 3)}`)
                             ]),
                             m('.w-col.w-col-10', [
